...
NodeTest.test("a rule matching inside a higher-priority rule's span is dropped", () => {
  ...
  NodeAssert.deepEqual(ruleIds(lint("Reworked scripts/t3x/worklog/lib/redact.mjs.")), [
    "long-path",
  ]);
});
...
NodeTest.test("hasErrors separates blocking findings from advice", () => {
  NodeAssert.equal(hasErrors(lint("Reworked scripts/t3x/worklog/lib/redact.mjs.")), false);
