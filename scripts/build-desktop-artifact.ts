...
// app to macOS. Set by .github/workflows/coil-release.yml; scripts/coil/verify-mac-signature.ts
// fails any artifact whose signing identifier is not the expected one, so an unset variable cannot
// ship silently.
