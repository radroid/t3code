...
Measured, not asserted: **34 upstream-owned files, +1600 / -187 lines**, against merge-base
...
| ----------------------------------------------------------------------- | -------- | ----- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/web/src/components/ChatView.tsx`                                  | +168/-1  | 60    | **10140** | Thread outbox: `handleQueueComposerSubmission`, queue-mode state, `onSend` early-return, `<ThreadOutboxQueueList>`, `sendLabel`, steer-vs-queue predicate           |
