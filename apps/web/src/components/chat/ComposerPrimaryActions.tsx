...
export const ComposerPrimaryActions = memo(function ComposerPrimaryActions({
  ...
  // Styling tracks upstream, which replaced the stage-backdrop treatment with
  // the message-action tokens. The only fork addition is the aria-label branch
  // for a running turn: on a steer-capable driver this submit folds into the
  // work in progress rather than starting a new turn, and that is invisible
  // otherwise.
  const sendButton = (
    <button
      type="submit"
