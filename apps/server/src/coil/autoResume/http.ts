 ...
 *
 *   GET  /api/coil/auto-resume?threadId=…  -> { enabled, overridePrompt, pending }
 *   POST /api/coil/auto-resume             -> same shape, after applying the write
 *
 ...
 * `server.ts`'s route list instead. See docs/coil/SEAMS.md.
 *
 * @module coil/autoResume/http
 */
 ...
 * signature. Here the requirement lands on the *layer* instead, where `coil/index.ts`
