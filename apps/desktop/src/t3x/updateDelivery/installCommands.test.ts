...
const MAC = {
  ...
  mountPoint: "/var/folders/x9/T/t3x-dmg-abc123",
  sourceAppPath: "/var/folders/x9/T/t3x-dmg-abc123/T3 Code (Alpha).app",
  stagedAppPath: "/Applications/T3 Code (Alpha).app.t3x-new",
};
