...
export class RelayError extends Schema.TaggedErrorClass<RelayError>()("CoilRelayError", {
  ...
  override get message(): string {
    return `coil update relay: ${this.reason} (${this.detail})`;
  }
}
 ...
 */
export const fetchLatestManifest = Effect.fn("coil.updateDelivery.fetchLatest")(function* (
  latestUrl: string,
) {
 ...
 */
export const streamRelayEvents = Effect.fn("coil.updateDelivery.stream")(function* (args: {
