...
const runCommand = Effect.fn("coil.updateDelivery.run")(function* (
  command: Command,
...
const freeBytesOn = Effect.fn("coil.updateDelivery.freeBytes")(function* (path: string) {
  const spawner = yield* ChildProcessSpawner.ChildProcessSpawner;
  const handle = yield* spawner.spawn(
 ...
 */
const downloadAsset = Effect.fn("coil.updateDelivery.download")(function* (args: {
 ...
 */
const sweepStagingDir = Effect.fn("coil.updateDelivery.sweep")(function* (args: {
 ...
 * the installer.
 */
export const stageUpdate = Effect.fn("coil.updateDelivery.stage")(function* (args: {
