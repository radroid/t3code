 ...
 *
 * The data is NOT defined here. It lives in scripts/t3x/install-instructions.json, which the
 * release workflow also renders into every GitHub release body via
 * scripts/t3x/render-release-notes.mjs. Two surfaces, one source — before issue #72 the release
 ...
 */
import instructions from "../../../../scripts/t3x/install-instructions.json";
